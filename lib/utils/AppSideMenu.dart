...
class AppMenu {
  ...
  static List<MenuSection> buildDefaultSections({
    ...
    bool Function()? hasPaiementAlerts, // optionnel : permet d’afficher un petit point rouge
  }) {
    final sections = <MenuSection>[
      ...
      MenuSection(
        ...
        hasAlerts: hasPaiementAlerts, // ✅ pas de badge nombre, juste une alerte possible
        items: const [
          MenuItem(
    ...
    // 🧑‍💼 Ajouter la section Super Admin seulement pour ce rôle
    if (role == 'SuperAdmin') {
      sections.add(
        MenuSection(
          title: 'Super Admin',
          ...
          items: const [
            ...
            MenuItem(
              ...
              icon: Icons.directions_car_filled_outlined,
              route: AppRoutes.superDocordremision, // ✅ nouvelle route
            ),
          ],
        ),
      );
